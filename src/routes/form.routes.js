...
import { createForm, listMyForms, getForms, updateForm, deleteForm, stopResponse, resumeResponse } from "../controllers/form.controller.js";
...
router.route("/:slug/resume-response").patch(authMiddleware, resumeResponse);
